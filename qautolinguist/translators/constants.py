...
#! Added in this modification, allow to use Unicode separators to join a batch into a single text
#? This idea aims to translate a batch of strings putting all in a single file.
#? More efficiency and faster
#? Negative fact: Translations can be of poorer quality as the translator induces the same context for the whole text, 
#? whereas a single sentence is easier to translate. 
#? ----------------------------------------------------------------
#? Here we propose some unicodes that represents spaces and joiners
#? that can be passed through GoogleTranslator API
